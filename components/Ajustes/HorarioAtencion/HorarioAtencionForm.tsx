...
// Detecta los días activos y devuelve un array de objetos con la información de cada día
function detectActiveDays(days: PractitionerAppointment[]) {
  const dias = [
    "Monday",
    "Tuesday",
    "Wednesday",
  ...
  return dias.map((dia) => {
    const found = days.find((day) => day.day === dia);
    if (found) {
      return {
        enable: true,
        horaInicio: found.startHour,
        horaFin: found.endHour,
      };
    } else {
      return {
        enable: false,
...
export default function HoraAtencionForm({
  setModify,
  practitionerAppointments,
}: Props) {
  const workingDays = detectActiveDays(practitionerAppointments);
  return (
    <div className="p-4 rounded-lg bg-white mt-4">
      ...
      <Formik
        ...
        initialValues={{
          lunes: {
            enable: workingDays[0].enable || false,
            horaInicio: workingDays[0].horaInicio || "",
            horaFin: workingDays[0].horaFin || "",
            custom: "",
          },
          martes: {
            enable: workingDays[1].enable || false,
            horaInicio: workingDays[1].horaInicio || "",
            horaFin: workingDays[1].horaFin || "",
            custom: "",
          },
          miercoles: {
            enable: workingDays[2].enable || false,
            horaInicio: workingDays[2].horaInicio || "",
            horaFin: workingDays[2].horaFin|| "",
            custom: "",
          },
          jueves: {
            enable: workingDays[3].enable || false,
            horaInicio: workingDays[3].horaInicio || "",
            horaFin: workingDays[3].horaFin || "",
            custom: "",
          },
          viernes: {
            enable: workingDays[4].enable || false,
            horaInicio: workingDays[4].horaInicio || "",
            horaFin: workingDays[4].horaFin || "",
            custom: "",
          },
          sabado: {
            enable: workingDays[5].enable || false,
            horaInicio: workingDays[5].horaInicio || "",
            horaFin: workingDays[5].horaFin || "",
            custom: "",
          },
          domingo: {
            enable: workingDays[6].enable || false,
            horaInicio: workingDays[6].horaInicio || "",
            horaFin: workingDays[6].horaFin || "",
            custom: "",
          },
          duracionTurno: practitionerAppointments[0]?.durationAppointment || "15",
        }}
        validate={(values) => {
          try {
